package com.udg.envio_de_fotos.Camara;
...
import com.udg.envio_de_fotos.Vistas.CameraActivity;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (Activity.RESULT_OK != resultCode) return;
            ...
            if (view != null) {
                ...
                bitmap = ImageUtility.savePicture(getActivity(), bitmap);
                ((CameraActivity) getActivity()).returnPhotoUri(bitmap);
            }
